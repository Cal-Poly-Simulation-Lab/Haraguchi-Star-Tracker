...
u37 = [-0.54429276; -0.1307443; 0.82864427];
u33 = [-0.45911157; 0.11504759; 0.88089762];

true = u37' * u33

% calculated distances away
% t1 = [0.46904311; 0.17272859; 0.86611974];
% t2 = [-0.24678614; 0.25170834; 0.93580955];

% distance that looks right for capturing whole screen
% t1 = [0.2886; 0.0058; 0.9574];
% t2 = [-0.1221; 0.0452; 0.9915];

% using 120 mm lens
% t1 = [0.55857084; -0.03105715; 0.82887519];
% t2 = [-0.30943545; 0.05532105; 0.94930993];

% 120 mm lens + full focal length
t1 = 
